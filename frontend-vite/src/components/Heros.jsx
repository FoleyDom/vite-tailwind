            ...
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <p class="mb-8 leading-relaxed text-blue-500">
                        <Balancer>
                            With an emphasis on having fun and building lasting friendships, 570
                            flag football is also highly competitive. Bringing together some of the
                            best local athletes, our area has to offer. This league is built
                            different! If you think you could keep up, register below. If you'd like
                            to come watch, click on the schedule button below.
                        </Balancer>
                    </p>
